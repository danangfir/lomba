...
class StockinExporter extends Exporter
{
    ...
    {
        return 'stockin-export-' . now()->format('Y-m-d_H-i-s') . '.xlsx';
    }
    ...
    {
        return \App\Models\Stockin::query()->with('product.category');
    }
    ...
    {
        return 'The Stockin export has been completed successfully!';
    }
}
